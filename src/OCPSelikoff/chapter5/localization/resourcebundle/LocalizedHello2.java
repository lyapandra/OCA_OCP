package OCPSelikoff.chapter5.localization.resourcebundle;
...
public class LocalizedHello2 {
    ...
    public static void main(String[] args) {
        ...
        printMovieDetails(ResourceBundle.getBundle("OCPSelikoff.chapter5.localization.resourcebundle.ResBundle", locale1));

        Locale locale2 = new Locale("it", "IT");
        printMovieDetails(ResourceBundle.getBundle("OCPSelikoff.chapter5.localization.resourcebundle.ResBundle", locale2));
    }
}
